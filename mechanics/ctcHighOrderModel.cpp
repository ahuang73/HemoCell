...
namespace hemo {
CtcHighOrderModel::CtcHighOrderModel(Config & modelCfg_, HemoCellField & cellField_) : CellMechanics(cellField_, modelCfg_),
                  cellField(cellField_),
                  k_volume( CtcHighOrderModel::calculate_kVolume(modelCfg_,*cellField_.meshmetric) ),
                  k_area( CtcHighOrderModel::calculate_kArea(modelCfg_,*cellField_.meshmetric) ), 
                  k_link( CtcHighOrderModel::calculate_kLink(modelCfg_,*cellField_.meshmetric) ), 
                  k_bend( CtcHighOrderModel::calculate_kBend(modelCfg_,*cellField_.meshmetric) ),
                  eta_m( CtcHighOrderModel::calculate_etaM(modelCfg_) ),
                  k_inner_rigid( CtcHighOrderModel::calculate_kInnerRigid(modelCfg_) ),
                  k_cytoskeleton( CtcHighOrderModel::calculate_kCytoskeleton(modelCfg_) ),
                  core_radius(CtcHighOrderModel::calculate_coreRadius(modelCfg_)),
                  radius(CtcHighOrderModel::calculate_radius(modelCfg_))
    {};

void CtcHighOrderModel::ParticleMechanics(map<int,vector<HemoCellParticle *>> & particles_per_cell, const map<int,bool> & lpc, size_t ctype) {
...
void CtcHighOrderModel::statistics() {
