...
*/
#ifndef HEMOCELL_CTCHIGHORDERMODEL_H
#define HEMOCELL_CTCHIGHORDERMODEL_H
...
namespace hemo {
class CtcHighOrderModel : public CellMechanics {
  ...
  public:
  CtcHighOrderModel(Config & modelCfg_, HemoCellField & cellField_) ;
